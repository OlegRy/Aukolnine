...
<div class="products">
	<div class="container">
		<div style = "margin-top:50px;height:50px;">
			...
			<a style = "margin-left:20px;text-decoration:none;color:white;" href = "#">Времени</a>
			<a style = "margin-left:10px;text-decoration:none;color:white;" href = "#">Категории</a>
			<a style = "margin-left:10px;text-decoration:none;color:white;" href = "#">Виду</a>
			<a style = "" class = "button" href = "#"><font style = "line-height:30px;">Купить  ставки</font></a>
		</div>
